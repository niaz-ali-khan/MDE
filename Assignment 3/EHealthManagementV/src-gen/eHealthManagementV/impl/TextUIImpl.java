 ...
 * </p>
 * <ul>
 *   <li>{@link eHealthManagementV.impl.TextUIImpl#getETextUIName <em>EText UI Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextUIImpl extends RepresentationInterfacesImpl implements TextUI {
	/**
	...
	protected EClass eStaticClass() {
		return EHealthManagementVPackage.Literals.TEXT_UI;
	}
	...
	public void setETextUIName(String newETextUIName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EHealthManagementVPackage.TEXT_UI__ETEXT_UI_NAME,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EHealthManagementVPackage.TEXT_UI__ETEXT_UI_NAME:
