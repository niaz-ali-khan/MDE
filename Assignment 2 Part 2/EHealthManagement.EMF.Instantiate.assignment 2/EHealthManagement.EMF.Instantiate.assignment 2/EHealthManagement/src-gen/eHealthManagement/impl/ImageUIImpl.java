 ...
 * </p>
 * <ul>
 *   <li>{@link eHealthManagement.impl.ImageUIImpl#getEImageUIName <em>EImage UI Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImageUIImpl extends RepresentationInterfaceImpl implements ImageUI {
	/**
	...
	public void setEImageUIName(String newEImageUIName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EHealthManagementPackage.IMAGE_UI__EIMAGE_UI_NAME,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EHealthManagementPackage.IMAGE_UI__EIMAGE_UI_NAME:
