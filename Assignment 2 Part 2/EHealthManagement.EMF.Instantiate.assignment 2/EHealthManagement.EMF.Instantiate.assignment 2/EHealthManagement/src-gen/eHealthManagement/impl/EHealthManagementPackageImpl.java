...
public class EHealthManagementPackageImpl extends EPackageImpl implements EHealthManagementPackage {
	 ...
	 * @generated
	 */
	public EReference getFileMessage_Attributes() {
		return (EReference) fileMessageEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getImageMessage_Attributes() {
		return (EReference) imageMessageEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(fileMessageEClass, FILE_MESSAGE__ATTRIBUTES);

		imageMessageEClass = createEClass(IMAGE_MESSAGE);
		createEReference(imageMessageEClass, IMAGE_MESSAGE__ATTRIBUTES);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getUser_UserTypes(), this.getAllowedUserTypes(), "UserTypes", null, 0, 1, User.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(userInterfaceEClass, UserInterface.class, "UserInterface", !IS_ABSTRACT, !IS_INTERFACE,
		...
		initEClass(messageTypeEClass, MessageType.class, "MessageType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMessageType_EMessageTypeName(), ecorePackage.getEString(), "EMessageTypeName", null, 0, 1,
		...
		initEAttribute(getFileMessage_EFileMessageName(), ecorePackage.getEString(), "EFileMessageName", null, 0, 1,
				...
				!IS_DERIVED, IS_ORDERED);
		initEReference(getFileMessage_Attributes(), this.getAttributes(), null, "attributes", null, 0, 1,
				FileMessage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(imageMessageEClass, ImageMessage.class, "ImageMessage", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getImageMessage_Attributes(), this.getAttributes(), null, "attributes", null, 0, 1,
				ImageMessage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(allowedAttributeTypesEEnum, AllowedAttributeTypes.LITERAL5);
