 ...
 *   <li>{@link eHealthManagement.DataSetType#getName <em>Name</em>}</li>
 * </ul>
 *
...
public interface DataSetType extends CommunicationInterface {
	 ...
	 * @see #setName(String)
	 * @see eHealthManagement.EHealthManagementPackage#getDataSetType_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link eHealthManagement.DataSetType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
